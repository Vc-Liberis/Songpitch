...
class SpotifyLocators:
    ...
    IS_THIS_COVER = By.CSS_SELECTOR("fieldset[data-encore-id=\"formGroup\"] div[data-encore-id=\"formRadio\"] label[for^=\"is-cover\"]")
    IS_IT_REMIX = By.CSS_SELECTOR("fieldset[data-encore-id='formGroup'] div[data-encore-id='formRadio'] label[for^='is-remix']")
    HOW_WAS_IT_RECORDED = By.CSS_SELECTOR("fieldset[data-encore-id='formGroup'] div[data-encore-id='formRadio'] label[for^='recording-type']")
    IS_IT_INSTRUMENTAL = By.CSS_SELECTOR("fieldset[data-encore-id='formGroup'] div[data-encore-id='formRadio'] label[for^='is-instrumental']")
